      ...
      <body className="bg-black muli">
        <nav className="w-100pc flex flex-column md-flex-row md-px-10 py-5 bg-black">
          ...
          <div id="nav-items" className="hidden flex sm-w-100pc flex-column md-flex md-flex-row md-justify-end items-center">
            <a href="#home" className="fs-s1 mx-3 py-3 indigo no-underline hover-underline">Home</a>
        ...
        <section id="home" className="min-h-100vh flex justify-start items-center">
          <div className="mx-5 md-mx-l5">
            ...
            <div>
              <h1 className="white fs-l3 lh-2 md-fs-xl1 md-lh-1 fw-900 ">Serve Your <br />Website Fast</h1>

              <div className="br-8 mt-10 inline-flex">
                <input type="text"
                  className="input-lg half bw-0 fw-200 bg-indigo-lightest-10 white ph-indigo-lightest focus-white opacity-80 fs-s3 py-5 min-w-25vw br-r-0"
                  placeholder="Email Address" />
                <button
                  className="button-lg bg-indigo-lightest-20 indigo-lightest focus-white fw-300 fs-s3 mr-0 br-l-0">Get
                        Started</button>
              </div>
